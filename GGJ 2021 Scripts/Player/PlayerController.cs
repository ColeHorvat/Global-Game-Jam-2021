...
//Headbobber Variables
    ...
    private void Start()
    {
        ...
        headbobber = GameObject.Find("Main Camera").GetComponent<Headbobber>();
        ...
        walkBobAmount = headbobber.bobbingAmount;
        walkBobSpeed = headbobber.bobbingSpeed;
    ...
    private void FixedUpdate()
    {
        ...
        if (m_Grounded)
        {
            ...
            if (!m_ToggleRun)
            {
                ...
                headbobber.bobbingAmount = Input.GetKey(KeyCode.LeftShift) ? runBobAmount : walkBobAmount;
                headbobber.bobbingSpeed = Input.GetKey(KeyCode.LeftShift) ? runBobSpeed : walkBobSpeed;
